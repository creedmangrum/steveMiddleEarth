...
var languageString = {
    "en": {
        "translation": {
            ...
            "GAME_NAME" : "Middle Earth Trivia", // Be sure to change this for your skill.
            "HELP_MESSAGE": "I will ask you %s multiple choice questions about the lore of Middle Earth. Respond with the number of the answer. " +
            "For example, say one, two, three, or four. To start a new game at any time, say, start game. ",
            "REPEAT_QUESTION_MESSAGE": "To repeat the last question, say, repeat. ",
            "ASK_MESSAGE_START": "Shall we begin?",
            "HELP_REPROMPT": "To give an answer to a question, respond with the number of the answer.",
            "STOP_MESSAGE": "Would you like to keep playing?",
            "CANCEL_MESSAGE": "As you wish. Get some rest and recover your strength.",
            "NO_MESSAGE": "The shadow in the east continues to grow. Speed your return so we may resume our journey. Farewell traveler!",
            "TRIVIA_UNHANDLED": "Try saying a number between 1 and %s",
            "HELP_UNHANDLED": "Say yes to continue, or no to end the game.",
            "START_UNHANDLED": "Say start to start a new game.",
            "NEW_GAME_MESSAGE": "Welcome to %s. ",
            "WELCOME_MESSAGE": "Welcome to Middle Earth Trivia. I will ask %s questions to test your mastery of this world\’s lore. Choose wisely, for knowledge is power and that which we do not know can be lost to the ages. And though the wise cannot see all ends, they can tell you some things are dangerous to forget. The future of this world could depend on you. " +
            "Just say the number of the answer. So it begins. ",
            "ANSWER_CORRECT_MESSAGE": "correct. ",
            "ANSWER_WRONG_MESSAGE": "Incorrect. ",
            "CORRECT_ANSWER_MESSAGE": "The correct answer is %s: %s. ",
            "ANSWER_IS_MESSAGE": "That answer is ",
            "TELL_QUESTION_MESSAGE": "Question %s. %s ",
            "GAME_OVER_MESSAGE": "You got %s out of %s questions correct. I await your return! Swift travels!",
    ...
    "en-US": {
        "translation": {
            "QUESTIONS" : questions["QUESTIONS_EN_US"],
            "GAME_NAME" : "American Middle Earth Trivia" // Be sure to change this for your skill.
        }			
    }
};
